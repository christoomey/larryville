...
hi ErrorMsg guifg=#dc322f guibg=#0000c0 guisp=#0000c0 gui=NONE ctermfg=160 ctermbg=none cterm=NONE
...
highlight Folded ctermfg=31

" }}}
" markdown headings {{{

highlight markdownHeadingDelimiter ctermfg=24
highlight markdownCodeDelimiter ctermfg=24
...
highlight asciiDiagram ctermfg=24
highlight todoTerm ctermfg=130
highlight markdownListMarker ctermfg=28
highlight TodoChar cterm=bold term=bold ctermfg=30
highlight todoTerm ctermfg=28
highlight astericLine ctermfg=166
highlight LarryAsteric ctermfg=162
highlight LarryMultiIndent ctermfg=24
highlight larrydash ctermfg=28
highlight itemDash ctermfg=32
highlight larryTilde ctermfg=126
highlight TodoChar cterm=bold term=bold ctermfg=30
highlight microProject ctermfg=125
highlight markdownError ctermbg=NONE
highlight htmlBold ctermbg=NONE
...
highlight pythonInclude ctermfg=166
highlight pythonbuiltin ctermfg=166
highlight pythonOperator ctermfg=166
highlight pythonExtraPseudoOperator ctermfg=166
highlight pythonExtraOperator ctermfg=126
highlight pythonConditional ctermfg=160
highlight pythonRepeat ctermfg=166

highlight pythonParen ctermfg=23
highlight pythonString ctermfg=202
highlight pythonNumber ctermfg=32
